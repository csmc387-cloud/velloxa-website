...
import { ArrowUpRight, MessageSquare, Brain, Code, TrendingUp } from 'lucide-react'
                            ...
                            <Card className="relative overflow-hidden h-full !bg-bg-primary/40 !backdrop-blur-[2px]">
                                <CardContent className="p-6 pt-6 h-full flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-white transition">AI Integration</h2>
                                        <p className="text-sm text-text-secondary">Embed custom AI solutions into your workflows to automate processes and supercharge your team&apos;s efficiency.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                            ...
                            <Card className="relative overflow-hidden h-full !bg-bg-primary/40 !backdrop-blur-[2px]">
                                <CardContent className="p-6 pt-6 h-full flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-text-secondary">Build high-converting, blazing-fast web applications designed to engage users and drive serious business growth.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                            ...
                            <Card className="relative overflow-hidden h-full !bg-bg-primary/40 !backdrop-blur-[2px]">
                                <CardContent className="p-6 pt-6 h-full flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-text-secondary">Execute data-driven marketing campaigns that resonate with your target audience and multiply your ROI.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                            ...
                            <Card className="relative overflow-hidden h-full !bg-bg-primary/40 !backdrop-blur-[2px]">
                                <CardContent className="grid pt-6 sm:grid-cols-2">
                                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            <h2 className="text-lg font-medium text-white transition">Seamless Scaling</h2>
                                    ...
                                    <div className="rounded-tl-[12px] relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/12 p-6 py-6 sm:ml-6 bg-black/75 backdrop-blur-md">
                                        ...
                                        <svg className="w-full sm:w-[150%] text-text-secondary" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                fillRule="evenodd"
                                                clipRule="evenodd"
                            ...
                            <Card className="relative overflow-hidden h-full !bg-bg-primary/40 !backdrop-blur-[2px]">
                                <CardContent className="grid h-full pt-6">
                                    <div className="relative z-10 flex flex-col justify-start space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            <h2 className="text-lg font-medium transition text-white">Constant Contact</h2>
                                            <p className="text-text-secondary text-sm">Keep your clients engaged with 24/7 automated support, instant responses, and streamlined communication channels that build lasting relationships.</p>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
